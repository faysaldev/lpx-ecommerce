...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        xs: "h-7 px-2 typography-label-sm [&_svg]:size-3",
        sm: "h-8 px-3 typography-label-sm [&_svg]:size-3.5",
        default: "h-9 px-4 typography-label-md [&_svg]:size-4",
        lg: "h-10 px-6 typography-label-lg [&_svg]:size-4",
        xl: "h-12 px-8 typography-body-lg [&_svg]:size-5",
        icon: "h-9 w-9 [&_svg]:size-4",
        "icon-sm": "h-8 w-8 [&_svg]:size-3.5",
        "icon-lg": "h-10 w-10 [&_svg]:size-4",
        "icon-xl": "h-12 w-12 [&_svg]:size-5",
      },
    },
    defaultVariants: {
      variant: "default",
