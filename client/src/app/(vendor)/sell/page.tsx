...
export default function BecomeVendorPage() {
  ...
  console.log(categoriesData?.data?.attributes);
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <Select name="category" required>
                        ...
                        <SelectContent>
                          {categoriesData?.data?.attributes?.map(
                            (category: any) => (
                              <SelectItem
                                key={category?._id}
                                value={category?.name}
                  ...
                  <div className="space-y-4">
                    ...
                    {socialMedia.length === 0 ? (
                      <div className="text-sm text-muted-foreground italic p-4 border-2 border-dashed rounded-lg bg-muted/30 text-center">
                        No social media profiles added yet. Add your profiles to
                        increase visibility.
                      </div>
                    ) : (
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        ...
                        there is a 3% transaction fee on all sales, and I agree
                        to comply with the platform{`'`}s vendor policies and
                        guidelines.
                      </p>
                    </div>
                  </div>
