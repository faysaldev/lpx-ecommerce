              ...
              <div className="rounded-2xl shadow-lg border border-gray-100 p-6">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    >
                      <SelectTrigger className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all h-auto">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Enter street, building, apartment number, etc."
                    />
                  </div>
                </div>
              </div>
