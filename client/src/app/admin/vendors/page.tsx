...
//             ? { ...vendor, status: reviewAction === "approve" ? "approved" : "suspended" }
//             : vendor
//         )
//       );
...
//       description: `Opening message composer for ${vendor.storeName}`,
//     });
//   };
...
//       const promises = selectedVendorsList.map(vendorId => {
...
//       setVendors(prevVendors =>
//         prevVendors.map(vendor =>
//           selectedVendorsList.includes(vendor.id)
//             ? { ...vendor, status: action === "approve" ? "approved" : "suspended" }
//             : vendor
//         )
//       );
...
//   // Effect to trigger the API call when statusFilter or searchQuery changes
//   useEffect(() => {
//     const fetchVendors = async () => {
//       try {
//         const response = await searchVendor({
...
//     };
//     fetchVendors();
//   }, [statusFilter, searchQuery, searchVendor]);
...
//                         {searchQuery
//                           ? "Try adjusting your search"
//                           : `No ${statusFilter === "all" ? "" : statusFilter} vendors found`}
//                       </p>
//                     </div>
//                   </TableCell>
//                 </TableRow>
